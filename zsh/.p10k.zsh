# Generated by Powerlevel10k configuration wizard on 2026-04-29 at 18:47 PDT.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 57633.
# Wizard options: compatible, rainbow, ascii, 2 lines, dotted, darkest-ornaments,
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    adb_device              # selected ADB device (gb-linux-kit adb-device-select plugin)
